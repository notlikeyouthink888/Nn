...
#: ACI 318M-14 جدول 8.10.5.1 — حصة شريحة العمود من العزم السالب الداخلي.
CS_NEG = 0.75
...
def _torsion(ex, ey, S, Lmin):
    """عزم الالتواء بالأركان وحديده — ACI 318M-14 المادة 8.7.3.1."""
    if S['way'] != 'two':
    ...
    return dict(required=True, M=round(pos, 2), length=round(Lmin / 5.0, 2),
                clause='ACI 318M-14 المادة 8.7.3.1',

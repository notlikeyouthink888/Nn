/* ============================================================================
   ...
   ما ينفّذه هذا المحرّك (وهو ما يفصل محرّكاً جادّاً عن محرّك تعليمي):
     ...
     ٣) **الإزاحات الصلبة عند الأطراف** (End Length Offsets) بمعامل منطقة
        ...
        وهو ما يجيزه ACI 318-19 §6.5.4 (المنهجية المبسّطة لتحليل العزوم
        التقريبية، بمعاملات جدول 6.5.2) وما يفعله ETABS.
     ...
     ٥) **حالات أحمال متعددة** تُحلّ بتحليل واحد للمصفوفة واستبدال خلفي لكل
        حالة (كما يفعل أي محرّك جادّ)، ثم **تراكيب ACI 318-19 §5.3.1** وغلاف
        (Envelope) القيم القصوى والدنيا.

     ٦) **ديافرام صلب** لكل طابق (Rigid Diaphragm) بثلاث درجات رئيسية.

   المراجع:
     • ACI 318-19 §19.2.2.1 · جدول 6.6.3.1.1(a) · §5.3.1 · §6.5.4 وجدول 6.5.2
       · §13.3 · جدول 22.5.5.1 وجدول 22.6.5.2 · جدول 24.2.2
...
(function (global) {
  ...
  /* معامل مرونة الخرسانة — ACI 318-19 §19.2.2.1 (بالميغاباسكال ثم kN/m²) */
  ...
  /** القوى عند **وجه الركيزة** — ACI 318-19 §6.5.4 يجيز قراءتها عند الوجه بدل
      المحور، بالمنهجية المبسّطة ومعاملات العزم بالجدول 6.5.2. */
  ...
  /** أقصى ترخيم **نسبي** عن الوتر الواصل بين العقدتين — وهو ما يُقارن بـ
      L/240 أو L/360 (ACI 318-19 جدول 24.2.2)، لا الإزاحة المطلقة التي تشمل
  ...
  /* تراكيب ACI 318-19 §5.3.1 — W و E بإشارتين لأن الاتجاه انعكاسي */

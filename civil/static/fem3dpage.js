...
(function (global) {
  ...
  function proofHTML(k) {
    ...
    H.push('<div class="stp"><h4>الخطوة ١ — خواصّ المقطع والمادة</h4>'
      + '<p>معامل المرونة من <b>ACI 318M §19.2.2.1</b>. مساحة القصّ الفعّالة κ·A و κ = 5/6 '
      ...
      + (m.mod !== 1 ? '<p class="wr">⚠️ معامل التشقّق <b>' + nf(m.mod, 2) + '</b> وفق '
        + '<b>ACI 318M-19 جدول 6.6.3.1.1(a)</b> — ' + (m.kind === 'col' ? '0.70·Ig للأعمدة'
    ...
    H.push('<div class="stp"><h4>الخطوة ٩ — قوى التصميم عند وجه الركيزة</h4>'
      + '<p><b>ACI 318M §6.3.2</b> يجيز التصميم على العزم عند وجه الركيزة بدل محورها. '
    ...
    H.push('<div class="stp"><h4>الخطوة ١٠ — الترخيم بتكامل الانحناء</h4>'
      ...
      + '&nbsp;&nbsp;(الحدّ 240 لـ ACI 318M جدول 24.2.2)</div></div>');

    H.push('<div class="stp"><h4>المراجع المعتمَدة</h4>'
      + '<ul style="color:var(--mut);font-size:12.5px;line-height:1.95;margin:4px 0;'
      + 'padding-inline-start:18px">'
      + '<li><b>ACI 318M-19</b> §19.2.2.1 (Ec) · جدول 6.6.3.1.1(a) (التشقّق) · §5.3.1 (التراكيب) '
      + '· §6.3.2 (وجه الركيزة) · §13.3 (الأساسات) · §22.5 و §22.6 (القصّ) · جدول 24.2.2 (الترخيم)</li>'

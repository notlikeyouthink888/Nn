...
(function (global) {
  ...
  var CSS = [
    ...
    '#fem button.lnk{background:rgba(56,189,248,.12);border:1px solid rgba(56,189,248,.4);',
      'color:#7dd3fc;padding:4px 9px;border-radius:7px;cursor:pointer;font:inherit;',
      'font-size:11px;white-space:nowrap;transition:.15s}',
    '#fem button.lnk:hover{background:rgba(56,189,248,.24);color:#fff}',
